...
<div class="app-title">
	<ul class="app-breadcrumb breadcrumb">
		...
		<li class="breadcrumb-item"><a href="{{url('/add_category')}}">{{ __('Add Category') }}</a>
		</li>		
	</ul>
</div>
			...
			<div class="col-lg-12">
				...
				<div class="card">
					...
					<div class="card-body" id="org-form">
						...
						<form class="form-horizontal" method="POST" action="{{ url('/store_category') }}" enctype="multipart/form-data" autocomplete="off">
						{{ csrf_field() }}

							<div class="form-group row">
								<label class="col-sm-4 form-control-label">{{ __('Category Name') }}</label>
								<div class="col-sm-8">
