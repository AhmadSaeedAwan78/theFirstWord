...
<div class="app-title">
	<ul class="app-breadcrumb breadcrumb">
		...
		<li class="breadcrumb-item"><a href="{{url('category')}}">{{ __('Categories') }} </a>
		</li>
		<li class="breadcrumb-item"><a href="{{url('/edit_category/'.$user->id)}}">{{ __('Update Category') }}</a>
		</li>		
	</ul>
</div>
...
<div class="row">
	...
	<div class="col-md-12">
		...
		<form class="form-horizontal" method="POST" action="{{ url('update_category/'. $user->id) }}" autocomplete="off" enctype="multipart/form-data">

			{{ csrf_field() }}

			<div class="tile">

				<h3 class="tile-title">{{ __('Update Category') }}</h3>
            ...
            @if($user->image)
          <div class="col-sm-6 col-md-6">
            <img src="{{asset('assets/category/'.$user->image)}}" height="125" width="225">
          </div>
            @endif
					...
					<div class="tile-footer col-sm-12 text-right">
						...
						<a href="{{url('category')}}" class="btn btn-default" style="border: solid 1px;">@lang('general.cancel')</a>
