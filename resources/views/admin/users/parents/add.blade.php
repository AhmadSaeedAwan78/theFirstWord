...
<div class="app-title">
	<ul class="app-breadcrumb breadcrumb">
		...
		<li class="breadcrumb-item"><a href="{{url('add_description/')}}">{{ __('Add Parents Description') }}</a>
		</li>		
	</ul>
</div>
			...
			<div class="col-lg-12">
				...
				<div class="card">
					...
					<div class="card-header d-flex align-items-center">
						<h3 class="h4">{{ __('Add Description') }}</h3>
					</div>
					<div class="card-body" id="org-form">
						<div class="card-body-form">
						<form class="form-horizontal" method="POST" action="{{ url('/store_description') }}" enctype="multipart/form-data" autocomplete="off">
						{{ csrf_field() }}

							<div class="form-group row">
								<label class="col-sm-4 form-control-label">{{ __('Title') }}</label>
								<div class="col-sm-8">
							...
							<div class="form-group row">
								<label class="col-sm-4 form-control-label">{{ __('Description') }}</label>
								<div class="col-sm-8">
									<textarea type="text" class="form-control" name="description" value="{{ old('description') }}" required autofocus rows="5"></textarea>
								</div>
							</div>
							<div class="line"></div>
